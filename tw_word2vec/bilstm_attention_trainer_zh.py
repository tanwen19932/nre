...
class BiLstmAttentionTrainer():
    ...
    model_path = "../data/model/re_zh_model.bilstm_attention.hdf5"
    ...
    def train(self,sentences_vector: SentencesVector):
        ...
        from tw_keras.AttentionLSTM import AttentionLSTM
        c1 = Bidirectional(AttentionLSTM(100, input_dtype=[100, 182]))(embedded_sequences)
